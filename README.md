...
- 240 数据结构与算法
  ...
  - 242 高级数据结构
    ...
    - [242.05 单调队列（滑动窗口的最大值）：队列都知道，单调队列有了解吗？](https://juejin.cn/post/7144939559489372168)

    - [242.06 单调栈（下一个更大元素）：栈都知道，单调栈有了解吗？](https://juejin.cn/post/7144769422882766885)

    - [242.07 并查集（动态连通）：如何使用并查集解决朋友圈问题？](https://juejin.cn/post/7143880364233064455)
